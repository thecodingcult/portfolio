...
export default function About() {
  return (
    <ContentShell>
      ...
      <p>
        Leto Hillza is a Senior who imagines computers as living organisms. His career spans quantum robotics, adaptive microcircuits, and speculative cognitive design.
      </p>
      <p>
