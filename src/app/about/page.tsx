...
export default function About() {
  return (
    <ContentShell>
      ...
      <p>
        Leto Hillza is a fictional neuromorphic engineer who imagines computers as living organisms. His career spans quantum robotics, adaptive microcircuits, and speculative cognitive design.
      </p>
      <p>
      ...
      <p>
        Outside of engineering, Leto spends his time sketching blueprints for interstellar habitats and writing short essays on computational philosophy.
      </p>
    </ContentShell>
  )
}
